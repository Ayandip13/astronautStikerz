      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
        ...
        <div className="w-full lg:w-1/2 relative h-[450px] lg:h-[550px]">
          ...
          <div className="absolute inset-0 bg-[#2a1b22] border border-white/10 rounded-3xl overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="w-full h-[65%] relative border-b border-white/10">
              <Image 
            ...
            <div className="p-8 flex-1 flex flex-col justify-center">
              <h3 className="font-display text-4xl font-bold mb-2 uppercase tracking-tight text-white">Original Art,<br/>No Excuses.</h3>
